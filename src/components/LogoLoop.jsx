// src/components/LogoLoop.jsx (MODIFICADO)
...
export const LogoLoop = memo(({ logos, speed = 120, direction = 'left', width = '100%', logoHeight = 28, gap = 32, pauseOnHover = true, fadeOut = false, fadeOutColor, scaleOnHover = false, ariaLabel = 'Partner logos', className, style }) => {
  ...
  const renderLogoItem = useCallback((item, key) => {
    ...
    // Eliminamos el 'a' tag y usamos 'li' con 'title' para el tooltip
    return (
